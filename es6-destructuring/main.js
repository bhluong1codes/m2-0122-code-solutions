...
const { title: bookTitle, author: bookAuthor, libraryID: libraryNum } = book2;

console.log(`The title of the book is ${bookTitle}, the author is ${bookAuthor}, and the library id is ${libraryNum}.`);
